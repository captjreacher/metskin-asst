...
import 'dotenv/config'; // loads .env locally, Render injects envs
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`✓ Assistant server listening on http://0.0.0.0:${PORT}`);
});
